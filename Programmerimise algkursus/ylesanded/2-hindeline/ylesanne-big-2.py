...
def make_pyramid(base: int, char: str) -> list:
    """
    Constructs a pyramid with the given base.

    Pyramid should consist of given chars, all empty spaces in the pyramid list are ' '. Pyramid height depends on base
    length. Lowest floor consists of base-number chars.
    ...
    :param base: int
    :param char: str
    :return: list pyramid in a 2 dimensional array.
    """
    ## TODO:
    return []
...
def join_pyramids(pyramid_a: list, pyramid_b: list) -> list:
    ...
    Get 2 pyramid lists as inputs. Join them together horizontally. If the the pyramid heights are not equal, add
    empty lines on the top until they are equal.
    ...
    :return: list pyramids in a 2 dimensional array.
    """
    ## TODO:
    return []
...
def to_string(pyramid: list) -> str:
    """
    Creates a pyramid string from 2 dimensional array pyramid.
